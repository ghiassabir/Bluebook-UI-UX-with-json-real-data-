...
<head>
    ...
    <title>Bluebook Prototype - Phase 5 (Real Data P1 - Split)</title>
    ...
    <!-- If you were using Tailwind via CDN, keep that link here too -->
    <!-- <script src="https://cdn.tailwindcss.com"></script> -->
    <!-- If you used Google Fonts via <link>, keep that here -->
...
<body>
    <div class="app-wrapper">
        ...
        <div class="calculator-overlay" id="calculator-overlay-main">
             <div class="calculator-header" id="calculator-header-draggable"> <strong>Calculator</strong> <button class="calculator-close-btn" id="calculator-overlay-close-btn">×</button> </div> <div class="calculator-body"> Desmos Calculator Placeholder </div>
        </div>
        <div class="reference-sheet-panel" id="reference-sheet-panel-main">
            <div class="reference-header"> <h3>Reference</h3> <button class="reference-close-btn" id="reference-sheet-close-btn">×</button> </div> <div class="reference-body"> <img src="https://i.postimg.cc/V6R7xL8k/sat-math-formula-sheet-sample.png" alt="Math Reference Sheet"> </div>
        </div>
    </div>
